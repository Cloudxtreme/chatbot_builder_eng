...
def random_chat(user, project, my_religion, others_religion):
    random_chat_ip = properties.get_random_chat_ip()
    return render_template("chat/random_chat.html", user = user, project = project, group_chat_ip = random_chat_ip, my_religion = my_religion, others_religion = others_religion)

def random_chat_mobile(user, project, my_religion, others_religion):
    random_chat_ip = properties.get_random_chat_ip()
    return render_template("chat/random_chat_mobile.html", user = user, project = project, group_chat_ip = random_chat_ip, my_religion = my_religion, others_religion = others_religion)
